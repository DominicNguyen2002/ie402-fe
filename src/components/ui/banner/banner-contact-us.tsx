...
export function BannerContactUs({ image }: Props) {
  return (
    <div className='relative h-[450px] w-full'>
      ...
      <div className='absolute top-0 bottom-0 left-0 right-0 px-[75px] py-[71px] bg-black/50'>
        <h5 className='mb-[10px] font-semibold text-heading-8 text-wheat'>Sản phẩm trang trí phòng tốt nhất</h5>
        ...
        <Button title='Mua ngay' variant='wheat' className='px-9 py-[15px] text-heading-7 leading-[30px] font-bold' />
      </div>
    </div>
  );
}
