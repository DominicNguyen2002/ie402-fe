...
export default function DiseaseCard({ title, image, _id, subTitle }: Props) {
    ...
    <div className='grid grid-cols-3 bg-scarlet w-[445px] h-[250px]'>
      <div className='pt-[35px] pl-[30px] col-span-2'>
        ...
        <Button
          ...
          title='Xem ngay'
          variant='secondary'
          className='px-5 py-2 mb-6 capitalize'
        />
      </div>
      <div className='flex items-center'>
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 600 600'>
          ...
          <image xlinkHref={image} clipPath={`url(#${_id})`} className='object-cover h-full' />
        </svg>
      </div>
    </div>
  );
